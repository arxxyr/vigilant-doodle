...
fn spawn_main_menu(
    ...
    commands
        ...
        .with_children(|parent| {
            ...
            text.0 = "Vigilant Doodle".to_string();
...
fn spawn_button(
    ...
    parent
        ...
        .with_children(|button: &mut ChildSpawnerCommands| {
            let (mut button_text, text_font, text_color) = button_text_style(font);
            button_text.0 = text.to_string();
            button.spawn((button_text, text_font, text_color));
        });
}
