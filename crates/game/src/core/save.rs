...
fn handle_save_request(
    ...
    player_query: Query<(&Transform, &crate::gameplay::Player), Without<crate::gameplay::Enemy>>,
    enemy_query: Query<
        (
            &Transform,
            &crate::ai::EnemyAIConfig,
            &crate::ai::DetectionConfig,
        ),
        With<crate::gameplay::Enemy>,
    >,
    game_progress: Res<crate::core::state::GameProgress>,
) {
    ...
    // 加密
    let encrypted = match crate::core::crypto::encrypt(&serialized) {
        Ok(data) => data,
        Err(e) => {
...
fn handle_load_request(
    mut save_manager: ResMut<SaveManager>,
    mut player_query: Query<(&mut Transform, &mut crate::gameplay::Player), Without<crate::gameplay::Enemy>>,
    mut enemy_query: Query<
        (
            &mut Transform,
            &mut crate::ai::EnemyAIConfig,
            &mut crate::ai::DetectionConfig,
        ),
        With<crate::gameplay::Enemy>,
    >,
    mut game_progress: ResMut<crate::core::state::GameProgress>,
) {
    ...
    // 解密
    let decrypted = match crate::core::crypto::decrypt(&encrypted) {
        Ok(data) => data,
        Err(e) => {
